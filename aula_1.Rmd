...
<<<<<<< HEAD
Dia 2  -  22/11 - Criando e e manipulando dados, noções de programação I  
Dia 3  -  23/11 - Leitura de arquivos, limpeza e manipuação de dados, noções de programação II  
Dia 4  -  28/12 -  Trabalhando com arquivos: noções de programação III  
...
Dia 9  -  13/12 - Programação para iniciantes  
Dia 10 -  14/12 - Programação para iniciantes II -Versionamento de código: noções de git  
...
>>>>>>> 38d82c10367a88aa9a777f76d3e22b2ca7489376
# O que é o R?
...
Muito cuidado com a digitação: para o R, maiúsculas e minúsculas são diferentes, e um espaço no meio da palvra atrapalha
...
_<-_ existe por motivos de compatibilidade com teclados que nao possuíam _=_ (lá dos tempos jurássicos da computação). Use _=_
...
Para criar o dataframe, podemos unir 2 ou mais vetores usando a função _data.frame()_
...
existem dois jeitos principais de acessar dados em um dataframe: colchetes _[]_ ou cifrão _$_
...
#Matrix
Matrizes são tabelas cujas colunas possuem apenas um tipo de dado, seja numerico ou texto. Podem ser criadas com as funções _matrix_, _cbind_, ou _rbind()_
