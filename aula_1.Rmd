...
Dia 2  -  22/11 - Leitura, limpeza e manipuação de dados, noções de lógica  de programação I  
Dia 3  -  23/11 - Leitura, limpeza e manipuação de dados, noções de lógica de programação II  
Dia 4  -  28/12 - Análise exploratória e funções matemáticas  
Dia 5  -  05/12 - Análise estatística básica no R - RCommander  
...
Aulas: teoria (1 a 2 h) + prática (até vocês desmaiarem)
...
# Funções
Quando temos um nome seguido de parentese com alguma coisa dentro, temos uma **função**
